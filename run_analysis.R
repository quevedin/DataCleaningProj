...
# File download verification. If file doesn't exist, download to working directory.
...
# melt data to tall skinny data and cast means. Finally write the tidy data to the working directory as "tidy_data.csv"
